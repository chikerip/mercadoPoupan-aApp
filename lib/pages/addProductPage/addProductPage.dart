...
class _addProductPage extends State<addProductPage> {
  ...
  postData(body) async{
    final result = await RemoteServicesAddProduct().postDB('${_localStorage.get('urlApi')}/product', _localStorage.get('token'), body);
                ...
                Column(
                        ...
                        Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (text) {
                                setState(() {
                                  if(text == ''){
                                    productRef = int.parse(widget.data);
                                  } else {
                                    productRef = int.parse(text);
                                  }
                                });
                              }
                            ),
                  ...
                  GestureDetector(
                    onTap: () {
                        ...
                        if(productImage == '' || productName == '' || price == 0.00 || promo == 0){
                          invalidParams();
                        } else {
